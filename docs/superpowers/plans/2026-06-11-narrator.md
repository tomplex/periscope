...
- [x] **Step 2: Verify the spec docs are present in the worktree**
...
- [x] **Step 3: Implement `tick` + `_generate`**
...
- [x] **Step 4: Wire `_worker_tick` and the lifespan prune**
...
- [x] **Step 6: Full suite sanity check**
...
- [x] **Step 1: Edit `RailRows.jsx` — replace the whole `PaneRow` function**
...
- [x] **Step 2: Edit `Detail.jsx` — header status line**
...
- [x] **Step 3: Edit `Inspector.jsx` — the 'rename' event kind**
...
- [x] **Step 6: Browser verification (no component tests — project convention)**
...
- [x] **Step 7: Run the full suite (guard against accidental backend edits)**
...
- [x] **Step 8: Commit (including the rebuilt bundle)**
...
- [x] **Step 1: Add the module-table row**
...
- [x] **Step 2: Add a short narrator section**
...
- [x] **Step 2: Merge to main (simple merge, never rebase — global convention)**
...
- [x] **Step 3: Run the suite on main**
